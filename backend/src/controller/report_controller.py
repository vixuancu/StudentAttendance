...
class ReportController:
    ...
    async def get_report_stats(
        ...
        data = await self.service.get_report_stats(course_section_id, from_date, to_date)
        return DataResponse(
            data=data,
    ...
    async def get_weekly_trend(
        ...
        data = await self.service.get_weekly_trend(course_section_id, from_date, to_date)
        return DataResponse(
            data=data,
            message="Lấy biểu đồ xu hướng tuần thành công"
        )
    ...
    async def get_class_summary(
        ...
        return DataResponse(
            data=data,
            message="Lấy thống kê theo lớp thành công"
        )
    ...
    async def get_report_details(
        ...
        data = await self.service.get_report_details(course_section_id, from_date, to_date, page, per_page)
        return DataResponse(
            data=data,
